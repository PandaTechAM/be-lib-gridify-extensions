...
public static class QueryableExtensions
{
   ...
   extension<TEntity>(IQueryable<TEntity> query) where TEntity : class
   {
      ...
      public IQueryable<TEntity> ApplyFilter(string filter)
      {
      ...
      public async Task<PagedResponse<TEntity>> GetPagedAsync(GridifyQueryModel model,
      ...
      public async Task<PagedResponse<TDto>> GetPagedAsync<TDto>(GridifyQueryModel model,
      ...
      public async Task<PagedResponse<TDto>> FilterOrderAndGetPagedAsync<TDto>(GridifyQueryModel model,
         Expression<Func<TEntity, TDto>> selectExpression,
         CancellationToken ct = default)
      {
         var mapper = RequireMapper<TEntity>();
      ...
      public async Task<CursoredResponse<TDto>> FilterOrderAndGetCursoredAsync<TDto>(GridifyCursoredQueryModel model,
         Expression<Func<TEntity, TDto>> selectExpression,
         CancellationToken ct = default)
      {
         var mapper = RequireMapper<TEntity>();
      ...
      public Task<CursoredResponse<TEntity>> FilterOrderAndGetCursoredAsync(GridifyCursoredQueryModel model,
         CancellationToken ct = default)
      {
         return query.AsNoTracking()
      ...
      public async Task<PagedResponse<object>> ColumnDistinctValuesAsync(ColumnDistinctValueQueryModel model,
      ...
      public async Task<CursoredResponse<object?>> ColumnDistinctValuesAsync(
      ...
      public async Task<object> AggregateAsync(AggregateQueryModel model,
         CancellationToken ct = default)
      {
         var mapper = RequireMapper<TEntity>();
         var filtered = query.ApplyFiltering(model, mapper)
